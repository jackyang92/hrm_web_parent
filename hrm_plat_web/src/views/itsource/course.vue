<template>
    ...
    private Long pid;
        -->
        <el-table :data="courses" @selection-change="selsChange" v-loading="listLoading" highlight-current-row
                  style="width: 100%;">
            <!--多选框-->
...
<script>
    export default {
        ...
        methods: {
            ...
            getCourseLevels() {
                //发送请求到后台获取数据
                this.$http.get("/management/systemdictionaryitem/listSn?sn=courseLevel")
                    .then(result => {
